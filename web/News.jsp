                ...
                <div class="contact-us">				
                    <div class="contact-us_left">
                        <div class="contact-us_info">
                            <h1 class="style">Find Us Here</h1>
				 ...
				 <h1>Latest News</h1>
                                 <br><br><br><br><br>
                                 <form name="News Form" action="News.jsp" method="POST">
                                 </form>
                                 
                                 <input type="submit" value="View News" />
                    ...
                    <div class="contact_right">
                        <div class="contact-form">
                            ...
                            <img src="images/a.jpg"  width="710" height="250">
                            <br><br><br>
                            <h1 align="center"style="color:Tomato;">Contact Us</h1>
                            ...
                            <form method="post" action="ContactUs.jsp">
                                ...
                                <div>
                                    <a href="ContactUs.jsp"><input type="submit" value="submit us"></a>
                                    
                                
                                       <input type="Reset" value="Reset" style="padding-top: 10px; padding-right: 24px;padding-left: 24px;padding-bottom: 10px;">
